  ...
  return (
    <div className="relative w-52" ref={ref}>
      ...
      <input
        ...
        className="w-full pl-8 pr-3 h-8 text-sm border border-border rounded-lg bg-transparent placeholder:text-muted-foreground outline-none focus:border-foreground/30 transition-colors"
      />
      {open && query.trim() && (
